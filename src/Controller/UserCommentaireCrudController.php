...
#[Route('/user/commentaires', name: 'user_commentaire_')]
class UserCommentaireCrudController extends AbstractController
{
    ...
    public function index(Request $request, EntityManagerInterface $em): Response
    {
        ...
        return $this->render('user_commentaire_crud/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $em, int $post_id): Response
    {
        ...
        return $this->render('user_commentaire_crud/new.html.twig', [
    ...
    {
        return $this->render('user_commentaire_crud/show.html.twig', ['commentaire' => $commentaire]);
    }
    ...
    public function edit(Request $request, Commentaire $commentaire, EntityManagerInterface $em): Response
    {
        ...
        return $this->render('user_commentaire_crud/edit.html.twig', [
            'commentaire' => $commentaire,
            'form' => $form->createView(),
        ]);
    }
