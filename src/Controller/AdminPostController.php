...
class AdminPostController extends AbstractController
{
    ...
    // ✅ Liste des publications avec likes
    ...
    // ✅ Modifier un post - CORRIGÉ pour accepter GET et POST
    ...
    public function show(int $id): Response
    {
        ...
        // Récupérer les likes des commentaires
        $commentLikesCount = [];
        $userLikedComments = [];
    ...
    public function editComment(int $id): Response
    {
        ...
        $user = $this->getUser();
        if ($commentaire->getUtilisateur()->getIdUtilisateur() !== $user->getIdUtilisateur()) {
