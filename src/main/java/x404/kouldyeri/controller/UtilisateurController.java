...
public class UtilisateurController implements Initializable {
    ...
    @FXML
    private void goProduitsF() {
        switchScene("/x404/kouldyeri/view/produitf.fxml");

    }

    @FXML
    private void goCommandesF() {
    ...
    private void switchScene(String fxmlPath) {
        try {
            ...
            Stage stage = (Stage) tableUtilisateurs.getScene().getWindow(); // tableUtilisateurs exists in your Utilisateur page
