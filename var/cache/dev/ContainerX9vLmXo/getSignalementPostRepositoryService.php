 ...
 */
class getSignalementPostRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SignalementPostRepository' shared autowired service.
     *
     * @return \App\Repository\SignalementPostRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SignalementPostRepository.php';

        return $container->privates['App\\Repository\\SignalementPostRepository'] = new \App\Repository\SignalementPostRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
