 ...
 */
class getNotifRequestRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\NotifRequestRepository' shared autowired service.
     *
     * @return \App\Repository\NotifRequestRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'NotifRequestRepository.php';

        return $container->privates['App\\Repository\\NotifRequestRepository'] = new \App\Repository\NotifRequestRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
