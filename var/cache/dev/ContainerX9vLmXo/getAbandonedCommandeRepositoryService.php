 ...
 */
class getAbandonedCommandeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AbandonedCommandeRepository' shared autowired service.
     *
     * @return \App\Repository\AbandonedCommandeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AbandonedCommandeRepository.php';

        return $container->privates['App\\Repository\\AbandonedCommandeRepository'] = new \App\Repository\AbandonedCommandeRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
