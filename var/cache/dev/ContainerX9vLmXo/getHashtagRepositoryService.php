 ...
 */
class getHashtagRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\HashtagRepository' shared autowired service.
     *
     * @return \App\Repository\HashtagRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'HashtagRepository.php';

        return $container->privates['App\\Repository\\HashtagRepository'] = new \App\Repository\HashtagRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
