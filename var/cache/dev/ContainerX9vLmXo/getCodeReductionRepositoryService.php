 ...
 */
class getCodeReductionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CodeReductionRepository' shared autowired service.
     *
     * @return \App\Repository\CodeReductionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CodeReductionRepository.php';

        return $container->privates['App\\Repository\\CodeReductionRepository'] = new \App\Repository\CodeReductionRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
