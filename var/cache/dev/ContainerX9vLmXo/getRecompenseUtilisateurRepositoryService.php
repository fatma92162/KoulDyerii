 ...
 */
class getRecompenseUtilisateurRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RecompenseUtilisateurRepository' shared autowired service.
     *
     * @return \App\Repository\RecompenseUtilisateurRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RecompenseUtilisateurRepository.php';

        return $container->privates['App\\Repository\\RecompenseUtilisateurRepository'] = new \App\Repository\RecompenseUtilisateurRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
