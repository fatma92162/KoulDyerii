 ...
 */
class getCollaborationProduitRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CollaborationProduitRepository' shared autowired service.
     *
     * @return \App\Repository\CollaborationProduitRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CollaborationProduitRepository.php';

        return $container->privates['App\\Repository\\CollaborationProduitRepository'] = new \App\Repository\CollaborationProduitRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
