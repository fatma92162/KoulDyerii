...
class getTwigService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Twig'.\DIRECTORY_SEPARATOR.'CensorshipExtension.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Twig'.\DIRECTORY_SEPARATOR.'MessageExtension.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Twig'.\DIRECTORY_SEPARATOR.'NotifRequestExtension.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Twig'.\DIRECTORY_SEPARATOR.'NotificationExtension.php';
        ...
        $instance->addExtension(new \App\Twig\CensorshipExtension());
        $instance->addExtension(new \App\Twig\MessageExtension(($container->privates['App\\Repository\\MessageRepository'] ?? $container->load('getMessageRepositoryService'))));
        $instance->addExtension(new \App\Twig\NotifRequestExtension(($container->privates['App\\Repository\\NotifRequestRepository'] ?? $container->load('getNotifRequestRepositoryService'))));
        $instance->addExtension(new \App\Twig\NotificationExtension(($container->privates['App\\Repository\\NotificationRepository'] ?? $container->load('getNotificationRepositoryService'))));
        ...
        $instance->addGlobal('loginAttemptService', ($container->privates['App\\Security\\LoginAttemptService'] ?? $container->load('getLoginAttemptServiceService')));
