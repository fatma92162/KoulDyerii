 ...
 */
class getPointssoldeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PointssoldeRepository' shared autowired service.
     *
     * @return \App\Repository\PointssoldeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PointssoldeRepository.php';

        return $container->privates['App\\Repository\\PointssoldeRepository'] = new \App\Repository\PointssoldeRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
