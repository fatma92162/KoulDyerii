 ...
 */
class getLigneCommandePlatRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LigneCommandePlatRepository' shared autowired service.
     *
     * @return \App\Repository\LigneCommandePlatRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LigneCommandePlatRepository.php';

        return $container->privates['App\\Repository\\LigneCommandePlatRepository'] = new \App\Repository\LigneCommandePlatRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
