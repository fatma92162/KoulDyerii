 ...
 */
class getPostReactionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PostReactionRepository' shared autowired service.
     *
     * @return \App\Repository\PostReactionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PostReactionRepository.php';

        return $container->privates['App\\Repository\\PostReactionRepository'] = new \App\Repository\PostReactionRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
