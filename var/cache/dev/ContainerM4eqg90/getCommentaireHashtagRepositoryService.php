 ...
 */
class getCommentaireHashtagRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CommentaireHashtagRepository' shared autowired service.
     *
     * @return \App\Repository\CommentaireHashtagRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CommentaireHashtagRepository.php';

        return $container->privates['App\\Repository\\CommentaireHashtagRepository'] = new \App\Repository\CommentaireHashtagRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
