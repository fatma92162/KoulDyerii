 ...
 */
class getInscriptionFormationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\InscriptionFormationRepository' shared autowired service.
     *
     * @return \App\Repository\InscriptionFormationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'InscriptionFormationRepository.php';

        return $container->privates['App\\Repository\\InscriptionFormationRepository'] = new \App\Repository\InscriptionFormationRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
