 ...
 */
class getGifFavoriRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\GifFavoriRepository' shared autowired service.
     *
     * @return \App\Repository\GifFavoriRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'GifFavoriRepository.php';

        return $container->privates['App\\Repository\\GifFavoriRepository'] = new \App\Repository\GifFavoriRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
