 ...
 */
class getVisitorActivityRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\VisitorActivityRepository' shared autowired service.
     *
     * @return \App\Repository\VisitorActivityRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'VisitorActivityRepository.php';

        return $container->privates['App\\Repository\\VisitorActivityRepository'] = new \App\Repository\VisitorActivityRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
