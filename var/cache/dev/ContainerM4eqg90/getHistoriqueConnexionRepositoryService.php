 ...
 */
class getHistoriqueConnexionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\HistoriqueConnexionRepository' shared autowired service.
     *
     * @return \App\Repository\HistoriqueConnexionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'HistoriqueConnexionRepository.php';

        return $container->privates['App\\Repository\\HistoriqueConnexionRepository'] = new \App\Repository\HistoriqueConnexionRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
