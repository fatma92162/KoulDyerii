...
#[Route('/user/posts', name: 'user_post_')]
class UserPostCrudController extends AbstractController
{
    ...
    public function index(Request $request, EntityManagerInterface $em): Response
    {
        ...
        return $this->render('user_post_crud/index.html.twig', [
            'posts' => $posts,
            'search' => $search,
            'sort' => $sort,
            'order' => $order,
    ...
    public function new(Request $request, EntityManagerInterface $em): Response
    {
        ...
        return $this->render('user_post_crud/new.html.twig', [
            'post' => $post,
            'form' => $form->createView(),
        ]);
    }

    // AJOUT DE LA ROUTE SHOW
    #[Route('/{id}', name: 'show', methods: ['GET'])]
    public function show(Post $post): Response
    {
        return $this->render('user_post_crud/show.html.twig', [
            'post' => $post,
        ]);
    }
    ...
    public function edit(Request $request, Post $post, EntityManagerInterface $em): Response
    {
        ...
        return $this->render('user_post_crud/edit.html.twig', [
            'post' => $post,
            'form' => $form->createView(),
        ]);
    }
